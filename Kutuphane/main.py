...
def sablon_indir():
    if os.path.exists("sablon.xlsx"):
        ...
        return "⚠️ sablon.xlsx dosyası bulunamadı."


@app.route('/oduncteki-sablon-indir')
def oduncteki_sablon_indir():
    if os.path.exists("oduncteki_bos_sablon.xlsx"):
        return send_file("oduncteki_bos_sablon.xlsx", as_attachment=True)
    else:
        return "⚠️ oduncteki_bos_sablon.xlsx dosyası bulunamadı."
...
def cezaevi_sablon_indir():
    if os.path.exists("cezaevi_bos_sablon.xlsx"):
        return send_file("cezaevi_bos_sablon.xlsx", as_attachment=True)
    else:
        return "⚠️ cezaevi_bos_sablon.xlsx dosyası bulunamadı."
